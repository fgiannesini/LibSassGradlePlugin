...
public class LibSassGradlePlugin implements Plugin<Project> {
	...
	public void apply(final Project project) {
		...
		final PluginParameters libSassParameters = extensions.create("libSassParameters", PluginParameters.class);
		((ExtensionAware) libSassParameters).getExtensions().create("libSassProductionParameters",
